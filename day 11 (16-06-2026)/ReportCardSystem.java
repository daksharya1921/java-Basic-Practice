...
{
	static char gradeReport(double avg){
		if (avg >= 90)	return 'A';
	...
	static double totalAverage(double sum)
	{
	...
	static double sumTotal(double markScience, double markMaths, double markEnglish){
	...
	static String printStudentName(String studentName){
	...
	static void printReportCard(String studentName, double markScience, double markMaths, double markEnglish){
